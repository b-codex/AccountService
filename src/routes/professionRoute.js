...
router.patch(
  ...
  async (req, res) => {
    ...
    profession.institution = _profession.institution || profession.institution;
    profession.educationLevel =
      _profession.educationLevel || profession.educationLevel;
    profession.fieldOfStudy =
      _profession.fieldOfStudy || profession.fieldOfStudy;
    profession.statedDate = _profession.statedDate || profession.statedDate;
    profession.endDate = _profession.endDate || profession.endDate;
